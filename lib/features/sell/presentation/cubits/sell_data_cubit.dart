...
import 'package:diary/features/buy/domain/entities/add_request_entity.dart';import 'package:equatable/equatable.dart';
...
class SellDataCubit extends Cubit<SellDataState> {
  ...
  void fetchSellData({required DateTime date})async{
    ...
    String id = date.toIso8601String().substring(0,10);
